---
name: pyrus-script-bots
description: Operating procedures, API specifications, rules, design patterns, and code snippets for creating, modifying, testing, and debugging Pyrus TypeScript server script bots in this codebase.
---

# Skill: Pyrus TypeScript Server Script Bot Developer
