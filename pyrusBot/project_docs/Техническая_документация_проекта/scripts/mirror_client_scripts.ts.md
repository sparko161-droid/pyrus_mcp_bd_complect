---
title: "Скрипт: mirror_client_scripts.ts"
audience: "internal"
pyrus_id: "Nmheg3UWzIO"
pyrus_parent: "HzQz5U8wZjh"
synced_at: "2026-08-10T13:46:22.000Z"
synced_hash: "sha256:7544dbe10b9480d2b46843c9587b1981"
---
...
function writeMirror(scriptPath: string): { path: string; changed: boolean } {
    ...
    const unchanged = existing.meta.title === title && existing.meta.audience === audience && contentHash(existing.body) === contentHash(body);
